...
SELECT age, year, SUM(count_alldrug) FROM sex_age_drug_count GROUP BY age, year;
...
SELECT age, SUM(count_opioid) as count_opioid, SUM(count_heroin) as count_heroin, SUM(count_stimulant) as count_stimulant FROM sex_age_drug_count GROUP BY age;
